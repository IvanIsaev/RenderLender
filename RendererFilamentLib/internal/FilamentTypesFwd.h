...
using RendererUnique =
  std::unique_ptr<filament::Renderer, FilamentComponentCleaner>;

using SwapChainUnique =
  std::unique_ptr<filament::SwapChain, FilamentComponentCleaner>;
...
using SkyboxUnique =
  std::unique_ptr<filament::Skybox, FilamentComponentCleaner>;

using VertexBufferUnique =
  std::unique_ptr<filament::VertexBuffer, FilamentComponentCleaner>;

using IndexBufferUnique =
  std::unique_ptr<filament::IndexBuffer, FilamentComponentCleaner>;
